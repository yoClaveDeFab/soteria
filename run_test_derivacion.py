...
from especialista_derivacion import root_agent
...
async def ask_question(question: str):
    ...
    session = await session_service.create_session(
        app_name="especialista_derivacion_app",
        user_id="user_test",
...
if __name__ == "__main__":
    ...
    query = " ".join(sys.argv[1:]) if len(sys.argv) > 1 else "¿Qué recursos tengo en Jalisco para una crisis emocional?"
