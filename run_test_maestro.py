...
from maestro import root_agent

async def main():
    print("==================================================================")
    print("      BIENVENIDO AL MAESTRO DE SoterIA (Google ADK)      ")
    print("==================================================================")
    print("Instrucciones:")
    print("- Para finalizar la conversación, escribe 'salir' o 'exit'.")
    print("- Escribe tu mensaje y presiona Enter para interactuar.")
    print("==================================================================\n")

    session_service = InMemorySessionService()
    session_id = "session_maestro_01"
    user_id = "facilitador_test"
    app_name = "maestro_app"
    ...
    print("SoterIA: Iniciando... Escribe 'Hola' para comenzar.")
...
if __name__ == "__main__":
    # Configurar la terminal para admitir salida UTF-8
